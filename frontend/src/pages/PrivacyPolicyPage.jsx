      ...
      <section className="mx-auto max-w-3xl px-4 sm:px-6 py-12 sm:py-16">
        ...
        <Section title="4. Berbagi Data ke Pihak Ketiga">
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              <strong>Google (Gemini API)</strong> — bila Anda memakai asisten Zecode, isi percakapan yang Anda ketik dikirim
              ke Google untuk diproses dan dijawab. Jangan sertakan data yang sangat sensitif dalam percakapan dengan Zecode
              kalau Anda tidak ingin data itu diproses pihak ketiga.
            </li>
