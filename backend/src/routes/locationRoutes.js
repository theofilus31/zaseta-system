...
router.post('/', requirePermission('locations', 'create'), ctrl.createLocation);
router.post('/import', requirePermission('locations', 'create'), upload.single('file'), ctrl.importLocations);
